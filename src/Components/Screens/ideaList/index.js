...
const IdeasPage = () => {
    ...
    const { stages, verticals, functions, users, demoDays } = useSelector((state) => state.common);
    const { isFetchingIdeas, ideaFilters, ideaSearchText } = useSelector((state) => state.idea);
        ...
        <div className="ideas-page">
            ...
            <div className="filters">
                ...
                <FormControl sx={{ m: 1, minWidth: 120 }}>
                    <Select
                        name="demoDayId"
                        value={filters.demoDayId}
                        onChange={handleFilterChange}
                        displayEmpty
                        inputProps={{ "aria-label": "All Demo Days" }}
                    >
                        <MenuItem value="">
                            <em>{"All Demo Days"}</em>
                        </MenuItem>
